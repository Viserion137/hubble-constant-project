...
\author{Alessandro Buttazzo \\ \small Independent research project, not conducted within a formal school or institutional research program}
\date{August 2, 2026}
\begin{document}
\maketitle
\tableofcontents
...
All distance and redshift data used in this analysis are publicly available from the NASA/IPAC Extragalactic Database (NED) at \url{https://ned.ipac.caltech.edu} (see Appendix~\ref{app:ned} for query details). Hubble's original 1929 dataset is reproduced from \citet{hubble1929}. The Python code used for the fits, uncertainty estimates, and sensitivity analysis, together with both datasets and all figures, is openly available at \url{https://github.com/Viserion137/hubble-constant-project} and archived with a permanent DOI at \url{https://doi.org/10.5281/zenodo.22260281}.
